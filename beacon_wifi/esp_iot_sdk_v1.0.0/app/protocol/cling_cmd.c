...
* FUNCTIONS
*/
LOCAL bool delete_cling_uart(CLASS(cling_uart) *arg);
LOCAL bool cling_data_recieved_poll(CLASS(cling_uart) *arg);
LOCAL bool cling_uart_taskid_register(CLASS(cling_uart) *arg, uint16 task_id);
LOCAL bool cling_data_send(CLASS(cling_uart) *arg, char *pinf, size_t lenth);
LOCAL bool enable_recieving(CLASS(cling_uart) *arg);
LOCAL bool disable_recieving(CLASS(cling_uart) *arg);
...
init_cling_uart(CLASS(cling_uart) *arg)
{
...
enable_recieving(CLASS(cling_uart) *arg)
{
...
#if 1
LOCAL bool ICACHE_FLASH_ATTR
cling_uart_taskid_register(CLASS(cling_uart) *arg, uint16 task_id)
{
    /*check object parameter*/
    assert(NULL != arg);
...
LOCAL bool ICACHE_FLASH_ATTR
cling_data_recieved_poll(CLASS(cling_uart) *arg)
{
...
LOCAL bool ICACHE_FLASH_ATTR
cling_data_send(CLASS(cling_uart) *arg, char *pinf, size_t lenth)
{
